...
namespace MiniSQL.CatalogManager
{
    class Program
    {
        ...
        {   //since quitstatement and execfile statement are too simple,we skip them here
            ...
            //select from table with 3 attribute
            SelectStatement select_with_3_attribute_true = new SelectStatement();
            select_with_3_attribute_true.FromTable = "Student";
            select_with_3_attribute_true.Condition = new Expression();
            Expression temp1 = new Expression();
            Expression temp2 = new Expression();
            Expression temp3 = new Expression();
            select_with_3_attribute_true.Condition.Ands.Add("ID",temp1);
            select_with_3_attribute_true.Condition.Ands.Add("Class",temp2);
            select_with_3_attribute_true.Condition.Ands.Add("Score",temp3);
            
            SelectStatement select_with_3_attribute_false = new SelectStatement();
            select_with_3_attribute_false.FromTable = "Student";
            select_with_3_attribute_false.Condition = new Expression();
            Expression temp1_2 = new Expression();
            Expression temp2_2 = new Expression();
            Expression temp3_2 = new Expression();
            select_with_3_attribute_false.Condition.Ands.Add("Gender", temp1_2);
            select_with_3_attribute_false.Condition.Ands.Add("Class", temp2_2);
            select_with_3_attribute_false.Condition.Ands.Add("Score", temp3_2);
            ...
            delete_with_3_attribute_true.Condition = new Expression();
            delete_with_3_attribute_true.TableName = "Student";
            Expression tmp1 = new Expression();
            Expression tmp2 = new Expression();
            Expression tmp3 = new Expression();
            delete_with_3_attribute_true.Condition.Ands.Add("ID", tmp1);
            delete_with_3_attribute_true.Condition.Ands.Add("Class", tmp2);
            delete_with_3_attribute_true.Condition.Ands.Add("Score", tmp3);

            DeleteStatement delete_with_3_attribute_false = new DeleteStatement();
            delete_with_3_attribute_false.TableName = "Student";
            delete_with_3_attribute_false.Condition = new Expression();
            Expression tmp1_2 = new Expression();
            Expression tmp2_2 = new Expression();
            Expression tmp3_2 = new Expression();
            delete_with_3_attribute_false.Condition.Ands.Add("ID", tmp1_2);
            delete_with_3_attribute_false.Condition.Ands.Add("Gender", tmp2_2);
            delete_with_3_attribute_false.Condition.Ands.Add("Score", tmp3_2);
