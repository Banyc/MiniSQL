...
namespace MiniSQL.BufferManager.Tests
{
    public class UnitTest1
    {
        ...
        {   //since quitstatement and execfile statement are too simple,we skip them here
            ...
            create_table_true.AttributeDeclarations = new List<AttributeDeclaration>(){
                new AttributeDeclaration() {AttributeName = "id", Type = AttributeTypes.Int},
                new AttributeDeclaration() {AttributeName = "price", Type = AttributeTypes.Float},
            };
            create_table_true.PrimaryKey = "id";
